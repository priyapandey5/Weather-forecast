...
function getWeatherData(city, unit, hourlyorWeek) {
  ...
  fetch(
    `https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${city}?unitGroup=metric&key=BYATH85VYV4LW2GBJH99THV99&contentType=json`,
    {
      method: "GET",
      headers: {},
    }
